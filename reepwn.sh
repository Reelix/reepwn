...
echo ""
echo -e "${NC}+------------------------------------------------------------------+"
echo -e "${YELLOW}|ReePwn Version 0.1 - By: Reelix - https://github.com/Reelix/reepwn${NC}|"
echo -e "+------------------------------------------------------------------+"
echo ""
echo -e "${YELLOW}OS${NC}"
echo -e "--${CYAN}"
